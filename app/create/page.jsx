...
function Create() {
    ...
    // used to save user input an generate ai course layout
    const GenerateCourseOutline=async()=>{
        ...
        // toast notification
        toast("Your course content is being generated, Click on Refresh Button")
  ...
  return (
    <div className='flex flex-col items-center p-5 md:px-24 lg:px-36 mt-20'>
        <h2 className='font-bold text-3xl text-blue-700'>Start Building Your Personal Study Material</h2>
